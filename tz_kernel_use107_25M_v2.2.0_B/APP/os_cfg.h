...
#define OS_MAX_EVENTS            11    /* Max. number of event control blocks in your application      */
...
#define OS_TICKS_PER_SEC       1000    /* Set the number of ticks in one second                        */
                                       ...
                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    250    /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE   250    /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   250    /* Idle       task stack size (# of OS_STK wide entries)        */
...
#define OS_TASK_DEL_EN            1    /*     Include code for OSTaskDel()     chanded by sjw to "1"                        */
