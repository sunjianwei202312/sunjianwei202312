...
#define FlashSetCle() { GPIOD->ODR |=1<<11;}       //GPIO_SetBits(GPIOD,GPIO_Pin_11)  //PD6
#define FlashClrCle() { GPIOD->ODR &= ~(1<<11); }  //GPIO_ResetBits(GPIOD,GPIO_Pin_11)         

#define FlashSetAle() { GPIOD->ODR |= (1<<12);}    //GPIO_SetBits(GPIOD,GPIO_Pin_5)   //PD5
#define FlashClrAle() { GPIOD->ODR &= ~(1<<12); }  //GPIO_ResetBits(GPIOD,GPIO_Pin_5)         


#define FlashSetWe()  { GPIOD->ODR |= (1<<5);}     //GPIO_SetBits(GPIOD,GPIO_Pin_14)  //PD14
#define FlashClrWe()  { GPIOD->ODR &= ~(1<<5); }   //GPIO_ResetBits(GPIOD,GPIO_Pin_14)

#define FlashSetRe()  { GPIOD->ODR |= (1<<4);}     //GPIO_SetBits(GPIOD,GPIO_Pin_15)  //PD15
#define FlashClrRe()  { GPIOD->ODR &= ~(1<<4); }   //GPIO_ResetBits(GPIOD,GPIO_Pin_15)
...
//FLASH最大能够达到的地址，是128M现在K9F1208U0B变为64M
