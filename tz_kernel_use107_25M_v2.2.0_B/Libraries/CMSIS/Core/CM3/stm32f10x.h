 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
 ...
 #ifdef STM32F10X_CL   
  #define HSE_VALUE    ((uint32_t)25000000) /*!< Value of the External oscillator in Hz *///((uint32_t)25000000)变为((uint32_t)8000000) added by sjw
 #else 
...
typedef enum {FALSE = 0, TRUE = !FALSE} bool;//added by sjw in 2022-3-16
